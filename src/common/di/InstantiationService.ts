...
import { dispose, isDisposable, toDisposable } from "../lifecycle";
...
export class InstantiationService implements IInstantiationService {
  ...
  createChild(services: ServiceCollection, store?: import("../lifecycle").DisposableStore): IInstantiationService {
