...
import { DashboardResizeHandle } from "@renderer/shared/ui/dashboard-resize-handle";
import { DashboardSidebarToggle } from "@renderer/shared/ui/dashboard-sidebar-toggle";
import {
  useBem,
  useComponentUI,
  useDashboard,
  useResizable,
} from "@renderer/shared/ui/composables";
