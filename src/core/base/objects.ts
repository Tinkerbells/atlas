...
import { isObject, isTypedArray, isUndefinedOrNull } from "./types";
...
function _cloneAndChange(obj: any, changer: (orig: any) => any, seen: Set<any>): any {
  ...
  if (isObject(obj)) {
    ...
    const o = obj as any;
    for (const i2 in o) {
      if (_hasOwnProperty.call(o, i2)) {
        r2[i2] = _cloneAndChange(o[i2], changer, seen);
      }
    }
    seen.delete(obj);
    return r2;
 ...
 * @param target the object to use for diffing
 */
...
export function mapValues<T extends object, R>(obj: T, fn: (value: T[keyof T], key: string) => R): { [K in keyof T]: R } {
