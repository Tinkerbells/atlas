...
export function isIterable<T>(obj: unknown): obj is Iterable<T> {
  return !!obj && typeof (obj as Record<symbol, unknown>)[Symbol.iterator] === "function";
}
...
export function isAsyncIterable<T>(obj: unknown): obj is AsyncIterable<T> {
  return !!obj && typeof (obj as Record<symbol, unknown>)[Symbol.asyncIterator] === "function";
}
 ...
 * ```
 */
export function isOneOf<TType, TSubtype extends TType>(value: TType, validValues: readonly TSubtype[]): value is TSubtype {
...
export function validateConstraint(arg: unknown, constraint: TypeConstraint | undefined): void {
  if (isString(constraint)) {
    ...
    if (typeof arg !== constraint) {
      throw new TypeError(`argument does not match constraint: typeof ${constraint}`);
    }
  }
    ...
    if (!isUndefinedOrNull(arg) && (arg as { constructor: unknown }).constructor === constraint) {
      return;
    }
