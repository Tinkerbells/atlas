...
import { illegalArgument } from '~/common/core/error-utils';
import { LexingError, Scanner, Token, TokenType } from './scanner';
import { CharCode } from '~/common/core/char-code';
import { isFalsyOrWhitespace } from '~/common/core/string-utils';
...
// TODO: invistigate how to make it export not from this file
