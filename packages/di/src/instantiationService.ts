...
import type { GetLeadingNonServiceArgs, ServiceIdentifier, ServicesAccessor } from "./instantiation.js";

import { Graph } from "./graph.js";
import { LinkedList } from "./linkedList.js";
import { SyncDescriptor } from "./descriptors.js";
import { ServiceCollection } from "./serviceCollection.js";
import { _util, IInstantiationService } from "./instantiation.js";
import { dispose, isDisposable, toDisposable } from "./lifecycle.js";
...
export class InstantiationService implements IInstantiationService {
  ...
  createChild(services: ServiceCollection, store?: import("./lifecycle.js").DisposableStore): IInstantiationService {
            ...
            if (typeof key === "string" && (key.startsWith("onDid") || key.startsWith("onWill"))) {
              ...
              const event: Event<any> = (callback, thisArg, disposables) => {
                if (idle.isInitialized) {
                  ...
                  const entry: EarlyListenerData = { listener: [callback, thisArg, disposables], disposable: undefined };
...
type Event<T> = (listener: (e: T) => unknown, thisArgs?: any, disposables?: IDisposable[]) => IDisposable;
