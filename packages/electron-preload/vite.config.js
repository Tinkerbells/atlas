...
import {getChromeMajorVersion} from '@atlas/electron-versions';
...
function handleHotReload() {
  ...
  return {
    name: '@atlas/preload-process-hot-reload',
    ...
    config(config, env) {
      ...
      const rendererWatchServerProvider = config.plugins.find(p => p.name === '@atlas/renderer-watch-server-provider');
