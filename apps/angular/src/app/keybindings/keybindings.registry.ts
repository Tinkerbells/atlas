...
import { DisposableStore } from '../shared/core/disposable'
import { OperatingSystem, OS } from '../shared/core/platform'
...
export const IKeybindingsRegistry = new InjectionToken<IKeybindingsRegistry>("IKeybindingsRegistry ", {
  providedIn: 'root',
